...
public final class forgotPassword_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("</head>\n");
      out.write("<body>\n");
      out.write("Enter your registered email address:\n");
      out.write("\t<form action=\"resetPassword\" method=\"post\">\n");
      out.write("\t\t<table>\n");
      out.write("\t\t\t<tr>\n");
      out.write("\n");
      out.write("\t\t\t\t<td colspan=\"2\"><input type=\"text\" name=\"email\"> </td>\n");
      out.write("\t\t\t</tr>\n");
      out.write("\t\t\t\n");
      out.write("\t\t\t<tr>\n");
      out.write("\t\t\t\t<td><input type=\"Submit\" value=\"Reset Password\">  </td>\n");
